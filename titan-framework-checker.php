		...
		public function display_install_or_active_notice() {
			...
			if ( ! $this->plugin_exists() ) {
				echo "<div class='error'><p><strong>"
					. esc_html( apply_filters( 'titan_checker_installation_notice', __( 'Titan Framework needs to be installed for Epic Sharer to work.', 'default' ) ) )
				...
				echo "<div class='error'><p><strong>"
					. esc_html( apply_filters( 'titan_checker_activation_notice', __( 'Titan Framework needs to be activated for Epic Sharer to work.', 'default' ) ) )
					. sprintf( " <a href='%s'>%s</a>",
